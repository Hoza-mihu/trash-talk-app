                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="w-32 sm:w-48 h-10 border border-gray-300 rounded-md px-3 text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                      />
                      <select
                        value={messageTarget}
